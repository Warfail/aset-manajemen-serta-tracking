    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $datastok = mysqli_query($conn, "select * from masuk ");
                                        $i = 1;
        ...
        <div class="modal fade" id="myModal">
            ...
            <div class="modal-content">
                ...
                <h4 class="modal-title">lAPTOP MASUK</h4>
                ...
                <br>
                <input type="number" name="ram" placeholder="RAM" class="form-control" required>
                <br>
                <input type="number" name="storage" placeholder="Storage" class="form-control" required>
                <br>
                <input type="text" name="keterangan" placeholder="Keterangan" class="form-control" required>
                <br>
                <button type="submit" class="btn btn-primary" name="laptopmasuk">Submit - Stok</button>
                <button type="submit" class="btn btn-primary" name="laptoprusak">Submit - Rusak</button>
                </div>
                </form>
