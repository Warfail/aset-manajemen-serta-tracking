                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$spesifikasi;?></td>
                                            <td>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit<?=$serial_number;?>">
                                                Edit
                                            </button>
                                            <input type="hidden" name="sndihapus" value="<?=$serial_number;?>">
                                    ...
                                    <div class="modal fade" id="edit<?=$serial_number;?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <br>
                                            <input type="text" name="model" value="<?=m     odel;?>" class="form-control" required>
                                            <br>
                                            <input type="text" name="spesifikasi" value="<?=spesidikasi;?>" class="form-control" required>
                                            <br>
                                            <button type="submit" class="btn btn-primary" name="tambahkanlaptop">Update</button>
                                            </div>
                                            </form>
