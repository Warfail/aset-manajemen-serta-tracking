...
if(isset($_POST['updatelaptop'])){
    ...
    $update = mysqli_query($conn, "update stock set serial_number='$serial_number', brand = '$brand', model='$model', processor ='$processor', processor ='$processor', st ='$storage' where serial_number = '$_POST[serial_number]'");
