...
if(isset($_POST['laptopkeluar'])) {
    ...
    $addmasuk = mysqli_query($conn, "insert into keluar(serial_number, brand, keterangan) values ('$serial_number', '$tujuan','$keterangan')");
    $updatestockmasuk = mysqli_query($conn, "delete from stock where serial_number = '$serial_number' ");
    if($addmasuk && $updatestockmasuk ) {
        header('location:masuk.php');
    } else {
