...
if(isset($_POST['outbound'])) {
    ...
    $sndel = $_POST['serial_number'];
    $sndel = $_POST['serial_number'];
    $sndel = $_POST['serial_number'];$sndel = $_POST['serial_number'];
    
        $laptopout = mysqli_query($conn, "insert into keluar (serial_number, ram, storage, status ) values ('$serial_number', '$ram', '$storage', '$status') where serial_number = '$snhapus'");
