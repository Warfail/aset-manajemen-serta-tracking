...
if(isset($_POST['laptopmasuk'])){
    ...
    $updatestockmasuk = mysqli_query($conn, "insert into stock(serial_number, brand, model, spesifikasi, processor, ram, storage) values ('$serial_number', '$brand','$model', '$spesifikasi', '$processor', '$r)");
