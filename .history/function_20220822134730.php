...
if(isset($_POST['laptoprusak'])){
    ...
    $addmasuk = mysqli_query($conn, "insert into masuk(serial_number, brand, keterangan) values ('$serial_number', '$brand','$keterangan')");
    $updatestockmasuk = mysqli_query($conn, "insert into rusak(serial_number, brand, model, spesifikasi, keterangan, tanggal) values ('$serial_number', '$brand','$model', '$spesifikasi', '$keterangan', '$tang')");
    if($addmasuk && $updatestockmasuk){
