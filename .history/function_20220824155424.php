...
if(isset($_POST['lepibarumasuk'])){
    ...
    $catatanbaru = mysqli_query($conn, "insert into lembiru(keterangan, serial_number, tanggal_pengembalian, tanggal_kembali) values ('$keterangan', '$serial_number', 'tanggal_pengem','$keterangan')");
    if($catatanbaru){
