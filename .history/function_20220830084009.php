...
if(isset($_POST['laptoprusak'])){
    ...
    $addmasuk = mysqli_query($conn, "insert into masuk(serial_number, brand, keterangan) values ('$serial_number', '$brand','$keterangan')");
    $stokrusak = mysqli_query($conn, "insert into rusak(serial_number, brand, model, processor, ram, storage, keter) values ('$serial_number', '$brand','$model', '$processor', '$ram', '$storage', '$status' )");
