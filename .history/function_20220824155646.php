...
if(isset($_POST['lepibarumasuk'])){
    ...
    $catatanbaru = mysqli_query($conn, "insert into laptopbaru_rusak(kerusakan, serial_number, tanggal_pengembalian, tanggal_kembali) values ('$kerusaka', '$serial_number', '$tanggal_pengembalian','$tanggal_kembali')");
    if($catatanbaru){
