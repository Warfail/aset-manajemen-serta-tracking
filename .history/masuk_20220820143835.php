            ...
            <div class="modal-content">
                ...
                <select name="brand" class="form-control">
                        <?php
                            ...
                            $takedata = mysqli_query($conn, "select brand from stock");
                            
                            while($fetcharray = mysqli_fetch_array($takedata)){
                                 
                                $brand = $fetcharray$fetcharray = array_unique($brand)['brand'];
                                //  $idmasuk = $fetcharray['id_masuk'];
                ...
                <br>
                <button type="submit" class="btn btn-primary" name="laptopmasuk">Submit</button>
                </div>
                </form>
