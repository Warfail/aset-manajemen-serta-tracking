    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Laptop Keluar</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                            ...
                                            //    $datakeluar = mysqli_query($conn, "select serial_number from stok");
                                            $i = 1;
        ...
        <div class="modal fade" id="myModal">
            ...
            <div class="modal-content">
                ...
                <br>
                <input type="text" name="keterangan" placeholder="Status" class="form-control" required>
                <br>
                <button type="submit" class="btn btn-primary" name="laptopkeluar">Submit</button>
                <br>
                <br>
                <!-- <button type="submit" class="btn btn-primary" name="ceksn">cek sn</button> -->
                </div>
                </form>
