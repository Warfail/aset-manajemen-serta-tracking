                                     ...
                                     <div class="modal fade" id="delete<?=$sn;?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <br>
                                            <button type="submit" class="btn btn-danger" name="hapuslaptop">Hapus</button>
                                            </div>
                                            </form>
                                            ...
                                            <div class="modal-footer">
                                            <input type="hidden" ">
                                            <button type="button" name="serial_number" value="<?php echo $serial_number['serial_number']?> class="btn btn-danger" data-dismiss="modal">Close</button>
