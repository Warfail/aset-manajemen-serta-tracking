...
if(isset($_POST['laptopkeluar'])) {
    ...
    $ceksn = mysqli_query($conn, "select serial_number from stock where serial_number ='$serial_numbe' ");
    while ($sn = mysqli_fetch_array($ceksn)){
        ...
        $sn = mysqli_query($conn, "delete serial_number from stock where serial_number = '$hapuslap' ");
