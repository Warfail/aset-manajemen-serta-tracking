                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <input type="text" name="serial_number" placeholder="Serial Number" value="<?=$serial;?>" class="form-control" >
                                            <br>
                                            <input type="text" name="brand" placeholder="brand" value="<?=$brand;?>" class="form-control" >
                                            <br>
                                            <input type="text" name="model" placeholder="Model" value="<?=$brand;?>" class="form-control" >
                                            <br>
                                            <input type="text" name="spesifikasi" placeholder="Spesifikasi" value="<?=$brand;?>" class="form-control" >
                                            <br>
