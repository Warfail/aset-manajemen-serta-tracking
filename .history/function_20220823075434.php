...
if(isset($_POST['updatelaptop'])){
    ...
    $update = mysqli_query($conn, "update stock set serial_number='$serial_number', brand = '$brand', model='$model', spesifikasi ='$spesifikasi' where sn='$sn'");
    if(update){
        header('location:rusak')
    }
