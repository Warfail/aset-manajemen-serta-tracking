...
if(isset($_POST['laptopkeluar'])) {
    ...
    $updatestockmasuk = mysqli_query($conn, "delete from stock where stock(serial_number, brand, model, processor, ram, storage) values ('$serial_number', '$brand','$model', '$processor', '$ram', '$storage')");
    if($addmasuk && $updatestockmasuk ) {
        header('location:masuk.php');
    } else {
