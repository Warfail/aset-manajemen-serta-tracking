...
if(isset($_POST['laptopkeluar'])){
    ...
    while ($sn = mysqli_fetch_array($ceksn)){
        ...
        $addkeluar = mysqli_query($conn, "insert into keluar(serial_number, tujuan ) values ('$serial_numb', '$tujuan')");
        $hapusstock = mysqli_query($conn, "delete from stock where serial_number ='$sn'");
...
if(isset($_POST['laptoprusak'])){
    ...
    $addmasuk = mysqli_query($conn, "insert into masuk(serial_number, brand, keterangan) values ('$serial_number', '$brand','$keterangan')");
    $stokrusak = mysqli_query($conn, "insert into rusak(serial_number, brand, model, processor, ram, storage, tanggal) values ('$serial_number', '$brand','$model', '$processor', '$ram', '$storage', $tanggal)");
