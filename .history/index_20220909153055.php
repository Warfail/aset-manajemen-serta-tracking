                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="lembiru.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                LAPTOP PEMBELIAN BARU
                            </a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#outbound<?=$sn;?>">
                                                Outbound
                                            </button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <br>
                                            <input type="text" name="processor" placeholder="Processor" value="<?=$processor;?>" class="form-control">
                                            <br>
                                            <input type="text" name="ram" placeholder="RAM" value="<?=$ram;?>" class="form-control">
                                            <br>
                                            <input type="text" name="storage" placeholder="Storage" value="<?=$storage;?>" class="form-control">
                                            <br>
                                     ...
                                     <div class="modal fade" id="delete<?=$sn;?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <br>
                                                <br>
                                            <button type="submit" class="btn btn-danger" name="hapuslaptop" value="<?=$serial_number;?>">Hapus</button>
                                            </div>
                                            </form>
                                    ...
                                    <div class="modal fade" id="outbound<?=$sn;?>">
                                        <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                            <div class="modal-body">
                                            <input type="hidden" name="brand" placeholder="Brand" value="<?=$brand;?>" class="form-control">
                                            
                                            <input type="hidden" name="model" placeholder="Model" value="<?=$model;?>" class="form-control">
                                            
                                            <input type="text" name="serial_number" placeholder="SERIAL_NUMBER" value="<?=$serial_number;?>" class="form-control">
                                            <br>
                                            <input type="text" name="ram" placeholder="RAM" value="<?=$ram;?>" class="form-control">
                                            <br>
                                            <input type="text" name="storage" placeholder="Storage" value="<?=$storage;?>" class="form-control">
                                            <br>
                                            <input type="text" name="status" placeholder="Status" value="<?=$keterangan;?>" class="form-control">
                                            <br>
                                            <button type="submit" class="btn btn-primary" name="outbound">Outbound</button>
                                            </div>
                                            </form>
...
onclick="return deleletconfig()"
        ...
        <div class="modal fade" id="myModal">
            ...
            <div class="modal-content">
                ...
                <br>
                <input type="text" name="processor" placeholder="Processor" class="form-control" required>
                <br>
                <input type="text" name="ram" placeholder="RAM" class="form-control" required>
                <br>
                <input type="text" name="storage" placeholder="Storage" class="form-control" required>
                <br>
