...
if(isset($_POST['outbound'])) {
    ...
    $model = $_POST['model'];
        ...
        $laptopout = mysqli_query($conn, "insert into keluar (brand, model, serial_number, ram, storage, status ) values ('$brand', '$serialnumber', '$serial_number', '$ram', '$storage', '$status')");
